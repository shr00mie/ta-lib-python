...
cdef extern from "ta-lib/ta_func.h":
    ...
    TA_RetCode TA_JMA(int startIdx, int endIdx, const double inReal[], int optInTimePeriod, int optInPhase, int optInVolPeriods, int *outBegIdx, int *outNBElement, double outRealJMA[], double outRealUpperBand[], double outRealLowerBand[])
    int TA_JMA_Lookback(int optInTimePeriod, int optInPhase, int optInVolPeriods)
